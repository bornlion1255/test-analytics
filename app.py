...
with tabs[4]:
    ...
    with st.expander("ℹ️ Логика цветовой индикации", expanded=False):
        ...
        | :--- | :--- | :--- | :--- |
        | **V (Volume)** | Рост (+) | 🔴 Red | Нагрузка выросла (Плохо для людей) |
        | **V (Volume)** | Снижение (-) | 🟢 Green | Нагрузка упала (Хорошо) |
        | **B (Bot)** | Рост (+) | 🟢 Green | Бот стал лучше закрывать чаты |
        | **B (Bot)** | Снижение (-) | 🔴 Red | Эффективность бота упала |
        """)
